...
export const AppProvider = ({ children }) => {
  ...
  const getProductDisplayName = (product) => {
    ...
    return fullName || name || brand || "Your selected car";
  };
  ...
  const addToCart = (product) => {
    ...
    const displayName = getProductDisplayName(normalized);
    ...
    setBookingToast({
      ...
      message: `${displayName} is ready in your booking list.`,
      key: Date.now(),
    });
  };
  ...
  const hideBookingToast = () => {
    setBookingToast((prev) => ({ ...prev, open: false }));
  };
