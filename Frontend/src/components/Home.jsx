...
const Home = () => {
  ...
  if (loading) {
    return (
      <div className="page-feedback page-feedback--loading">
        Loading cars…
      </div>
    );
  }
    ...
    return (
      <>
        <div className="page-feedback page-feedback--empty">
          <div className="page-feedback__title">
          ...
          <details className="page-feedback__debug">
            <summary style={{ cursor: "pointer" }}>
              Debug: show fetched data
            </summary>
            <pre className="page-feedback__debug-pre">
