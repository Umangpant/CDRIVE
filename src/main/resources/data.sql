 ...
 -- CRITICAL FIX: Delete existing data to prevent "Duplicate entry" error on startup
 DELETE FROM product_model;

 -- Insert statement with updated feature descriptions
 INSERT INTO product_model ( id, brand, category, daily_rental_rate, description, fuel_type, image_data, image_name, image_type, model_year, name, available_location, seating_capacity ) VALUES
